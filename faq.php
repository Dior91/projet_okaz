...
<!-- Contenu de la page -->
<div class="container py-20 px-40">
    <h2 class="text-center text-darkblue text-3xl font-semibold mb-20 ">Retrouvez les réponses aux questions les plus fréquemment posées</h2>
    <div class="flex flex-col space-y-16">
    <div class="w-2/3">
        <h3 class="font-semibold text-2xl mb-5 text-orange">Comment vendre sur OKAZ ?</h3>
        <p class="text-xl"> Il est possible de nous proposer vos meubles à la vente. Nos experts se chargent d'estimer leur valeurs. 
    ...
    <div class="w-2/3">
        ...
        <p class="text-xl"> Sur chaque page produit, il est indiqué le magasin dans lequel le produit est disponible. Vous avez alors la possibilité d'aller acheter le produit directement en magasin.
    ...
    <div class="w-2/3">
        ...
        <p class="text-xl"> Vous pouvez retourner tout article acheté en ligne dans le délai légal de 14 jours. Pour cela, il suffit de nous contacter par mail 
    ...
    <div class="w-2/3">
        ...
        <p class="text-xl">Dès lors que votre commande est validée, nos équipes se chargent de la préparer dans les plus brefs délais
    ...
    <div class="w-2/3">
        ...
        <p class="text-xl">Les frais de livraison de votre commande dépendent du poids de votre commande, du transporteur et de votre localité.
        </p>
    </div>
    </div>
</div>
